...
class MainViewController: UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        showViewController(viewController: HomeScreen.self, storyboardId: "HomeScreenID")
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 0:
            // Home
            self.showViewController(viewController: HomeScreen.self, storyboardId: "HomeScreenID")
        case 1:
            // Music
            self.showViewController(viewController: MusicScreen.self, storyboardId: "MusicScreenID")
